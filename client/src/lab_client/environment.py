...
from docknet.clients import AuthClient, FileClient, ExtensionClient
from docknet.clients import DeploymentClient
from docknet.clients.shared import BaseUrlSession
from docknet.config import API_TOKEN_NAME
from docknet.schema import File
...
class Environment:
    ...
    def setup_mlflow(self) -> None:
        ...
        * Uses the docknet API to check if the ML Flow extension is installed
