...
# Install Docknet
RUN pip install "docknet[server]==0.0.23"
# Uncomment lines below if you want to install your local docknet code (useful when developing docknet features)
...
# COPY ./docknet/backend/setup.py /resources/app/docknet/
# RUN pip install /resources/app/docknet[server]
# COPY ./docknet/backend /resources/app/docknet
# RUN pip install /resources/app/docknet[server]
...
LABEL org.opencontainers.image.source https://github.com/khulnasoft/ml-lab
