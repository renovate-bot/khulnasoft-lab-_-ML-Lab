...
from docknet.schema import Service, ServiceInput
from docknet.schema.auth import USER_ID_PARAM, AccessLevel
...
from docknet.utils import fastapi_utils
...
from lab_workspace_manager.utils import DOCKNET_API_ENDPOINT, get_component_manager
...
def create_ws_service_input(
    ...
    return ServiceInput(
        ...
        endpoints=["8080b"],
        parameters={
            "WORKSPACE_BASE_URL": "{env.DOCKNET_SERVICE_URL}",
            "SSH_JUMPHOST_TARGET": "{env.DOCKNET_DEPLOYMENT_NAME}",
            "SELF_ACCESS_TOKEN": "{env.DOCKNET_API_TOKEN}",
            "LAB_API_ENDPOINT": "{env.DOCKNET_API_ENDPOINT}",
