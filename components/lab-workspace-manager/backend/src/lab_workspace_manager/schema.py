...
import pydantic
from docknet.schema.deployment import DeploymentStatus
...
class WorkspaceBase(BaseModel):
    ...
    container_image: str = Field(
        ...
        example="khulnasoft/ml-workspace-minimal:latest",
        max_length=2000,
...
class Workspace(WorkspaceBase):
    ...
    access_url: Optional[str] = Field(
        ...
        description="Relative docknet url that provides access to the workspace.",
    )
