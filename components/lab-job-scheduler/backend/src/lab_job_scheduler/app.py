...
from docknet.schema.exceptions import CREATE_RESOURCE_RESPONSES
from docknet.utils import fastapi_utils, id_utils
...
from lab_job_scheduler.utils import DOCKNET_API_ENDPOINT, get_component_manager
...
def on_startup() -> None:
    token = os.environ["DOCKNET_API_TOKEN"]  # TODO: Use a better way to get the token.
