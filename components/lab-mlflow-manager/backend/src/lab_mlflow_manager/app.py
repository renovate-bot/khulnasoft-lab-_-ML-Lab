...
from docknet.schema.deployment import ACTION_START, SERVICE_ID_PARAM
...
from lab_mlflow_manager.utils import DOCKNET_API_ENDPOINT, get_component_manager
...
def deploy_mlflow_server(
    ...
    host = str(parse.urlparse(os.getenv("DOCKNET_API_ENDPOINT")).netloc)
