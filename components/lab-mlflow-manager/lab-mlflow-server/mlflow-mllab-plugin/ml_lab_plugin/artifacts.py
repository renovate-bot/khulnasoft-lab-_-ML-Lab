...
from docknet.clients import FileClient
...
class MlLabArtifactRepository(ArtifactRepository):
    ...
    def __init__(self, artifact_uri):
        ...
        if "DOCKNET_API_ENDPOINT" in os.environ:
            url = os.environ["DOCKNET_API_ENDPOINT"]
        ...
        self.default_artifact_root = 'projects/{}/services/{}/access/5001/'.format(
            self.project_id,
            os.getenv("DOCKNET_DEPLOYMENT_NAME", "pylab-p-{}-s-ml-flow-1c457".format(self.project_id))
        )
    ...
    def _download_file(self, remote_file_path, local_path):
        ...
        print("Downloaded file from docknet")
